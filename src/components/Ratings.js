...
function Ratings({ratings}) {
  return (
    <div className='text-light border-top border-bottom border-3 my-3 p-3 rounded border-warning d-flex w-100 flex-column'>
            <h1 className='text-warning text-center m-3'>Ratings:</h1>
                ...
                <div className='row w-100 d-flex justify-content-around'>
                    <div className='col-xl-3 col-lg-3 col-md-6 col-sm-2 text-center'>
